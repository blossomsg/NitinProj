...
class MassPlayblastLay(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.animcog_mpb_usealllights_qpushbutton.setStyleSheet("QPushButton:pressed{background:#054f6d; border:none} "
                                                                ...
                                                                "E:\\Proj_Codes\\NitinProj\icons\\anim_conglomeration"
                                                                "\\viewport_modes\\vp_icon_lights.png); border:none} "
        ...
        self.animcog_mpb_shadows_qpushbutton.setStyleSheet("QPushButton:pressed{background:#054f6d; border:none} "
                                                           ...
                                                           "QPushButton:hover:checked{image: url("
                                                           "E:\\Proj_Codes\\NitinProj\icons\\anim_conglomeration"
                                                           "\\viewport_modes\\vp_icon_shadows.png); border:none} "
                                                           "QPushButton:hover{E:\\Proj_Codes\\NitinProj\icons"
                                                           "\\anim_conglomeration\\viewport_modes\\vp_icon_shadows"
                                                           ".png); border:none}")
        ...
        self.animcog_mpb_ambocclusion_qpushbutton.setStyleSheet("QPushButton:pressed{background:#054f6d; border:none} "
                                                                ...
                                                                "QPushButton:hover:checked{image: url("
                                                                "E:\\Proj_Codes\\NitinProj\icons\\anim_conglomeration"
                                                                "\\viewport_modes\\vp_icon_ambient_occlusion.png); "
                                                                "border:none} "
                                                                "QPushButton:hover{E:\\Proj_Codes\\NitinProj\icons"
                                                                "\\anim_conglomeration\\viewport_modes"
                                                                "\\vp_icon_ambient_occlusion.png); border:none}")
        ...
        self.animcog_mpb_antialiasing_qpushbutton.setStyleSheet(
            ...
            "E:\\Proj_Codes\\NitinProj\icons\\anim_conglomeration\\viewport_modes\\vp_icon_anti_aliasing.png); "
            "border:none} "
            "QPushButton:hover{E:\\Proj_Codes\\NitinProj\icons\\anim_conglomeration\\viewport_modes"
            "\\vp_icon_anti_aliasing.png); border:none}")
