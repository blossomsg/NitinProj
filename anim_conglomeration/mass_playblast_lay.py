...
class MassPlayblastLay(QtWidgets.QWidget):
	...
	def __init__(self):
		...
		self.animcog_mpb_ambocclusion_qpushbutton.setIcon(QtGui.QIcon("E:\\Proj_Codes\\NitinProj\\anim_conglomeration\\icons\\question-mark.png"))
		...
		self.animcog_mpb_usealllights_qpushbutton.setIcon(QtGui.QIcon("E:\\Proj_Codes\\NitinProj\\anim_conglomeration\\icons\\question-mark.png"))
		...
		self.animcog_mpb_path_qlineedit.setStyleSheet("QLineEdit {background-color:#054f6d; color:#81d0ef; border: 1px solid #054f6d;}")
		...
		self.animcog_mpb_vp_combobox.setStyleSheet("QComboBox {background-color:#054f6d; color:#81d0ef; background:#054f6d} QComboBox QAbstractItemView {background-color:#054f6d; color:#81d0ef; background:#054f6d}")
		...
		self.animcog_mpb_parent_horizontal_vertical_layout = QtWidgets.QVBoxLayout(self.animcog_mpb_toolbox_palyblast_column)
